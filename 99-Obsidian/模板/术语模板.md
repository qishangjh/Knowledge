...
name: <% tp.file.title %>
aliases:
  - <% tp.system.prompt("请输入术语别名，默认为空", "") %>
  - <% tp.user.free_translate.freeTranslate(tp, tp.file.title) %>
tags:
  - concept
---
...
>
> [!seealso]+ Source
> <% tp.user.get_source_file(tp) %>

<% tp.user.free_translate.handleUserInputAndAI(tp, tp.file.title) %>
