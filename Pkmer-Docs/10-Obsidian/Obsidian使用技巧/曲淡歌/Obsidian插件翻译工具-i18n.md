...
![Pasted image 20250112232701](https://cdn.pkmer.cn/images/202501222228814.png!pkmer)
...
![Pasted image 20250112232711](https://cdn.pkmer.cn/images/202501222228816.png!pkmer)

#### 译文编辑器

在这里可以自由编辑词典。

![Pasted image 20250112232719](https://cdn.pkmer.cn/images/202501222228817.png!pkmer)

#### 译文审核面板

云端的插件都是由热心志愿者无偿维护的，每个词典均经过审核，保证新手可以开箱即用。

![Pasted image 20250112232725](https://cdn.pkmer.cn/images/202501222228818.png!pkmer)

#### 沉浸式翻译

如果某个插件还没有云端词典，也可以使用沉浸式翻译来机翻。

![Pasted image 20250112232735](https://cdn.pkmer.cn/images/202501222228819.png!pkmer)
...
![Pasted image 20250112232749|690x568](https://cdn.pkmer.cn/images/202501222228820.png!pkmer)
...
![Pasted image 20250112232924](https://cdn.pkmer.cn/images/202501222228821.png!pkmer)

下载 `main.js`、`manifest.json`、`style.css` 这三个文件

![Pasted image 20250112232942](https://cdn.pkmer.cn/images/202501222228822.png!pkmer)

再把文件复制到 Obsidian 库内的隐藏文件夹中，路径为 `Obsidian库文件夹/.obsidian/plugins/i18n`

![Pasted image 20250112232949](https://cdn.pkmer.cn/images/202501222228823.png!pkmer)
...
1. 打开 i18n 设置，确认云端模式已打开 ![Pasted image 20250112232956](https://cdn.pkmer.cn/images/202501222228825.png!pkmer)
2. 点击 Obsidian 左侧的 i18n 图标 ![Pasted image 20250112233010](https://cdn.pkmer.cn/images/202501222228826.png!pkmer)
3. 如果本地不存在词典，且对应插件云端已有分享词典，你会在插件后面看到一个 `下载` 按钮，如果云端没有词典，则没有下载按钮 ![Pasted image 20250112233019](https://cdn.pkmer.cn/images/202501222228827.png!pkmer)
	- 注：如果**本地已有词典**，`下载` 按钮也**不会**出现，需要删除本地词典
4. 点击 `下载` 按钮后，会出现下载面板，点击 `保存` 按钮即可 ![Pasted image 20250112233031](https://cdn.pkmer.cn/images/202501222228828.png!pkmer)
5. 保存完成后，`提取` 按钮会变成 `替换` 按钮，点击 `替换` 后对应插件就会被翻译，如果依然插件界面未翻译，则需要重启 Obsidian ![Pasted image 20250112233041](https://cdn.pkmer.cn/images/202501222228829.png!pkmer)
...
1. 点击 i18n 控制面板右上角的调色板符号 ![Pasted image 20250112233058](https://cdn.pkmer.cn/images/202501222228830.png!pkmer)
2. 在这个 Style Settings 专属面板中按照普通插件的翻译流程操作即可 ![Pasted image 20250112233105](https://cdn.pkmer.cn/images/202501222228831.png!pkmer)
...
![Pasted image 20250112233115](https://cdn.pkmer.cn/images/202501222228832.png!pkmer)
...
![Pasted image 20250112233124](https://cdn.pkmer.cn/images/202501222228833.png!pkmer)
...
编辑器打开按钮：![Pasted image 20250112233132](https://cdn.pkmer.cn/images/202501222228834.png!pkmer)

编辑器：

![Pasted image 20250112233138](https://cdn.pkmer.cn/images/202501222228835.png!pkmer)
...
1. 配置接口（二选一即可）：
	- 百度接口 ![Pasted image 20250112233151](https://cdn.pkmer.cn/images/202501222228836.png!pkmer)
	- OpenAI 接口 ![Pasted image 20250112233157](https://cdn.pkmer.cn/images/202501222228837.png!pkmer)
	- 确保插件未提取词典，点击 `AI` 按钮即可开始机器翻译 ![Pasted image 20250112233202](https://cdn.pkmer.cn/images/202501222228838.png!pkmer)

### 提交词典至云端

1. 确保已开启 `共建云端` 中的 `贡献者模式`，如果不执行第 2 步，则使用集体账号署名
2. （可选）如果你拥有 Gitee 账号，想保留自己的署名，同时也让自己的账号成为 i18n 的贡献者，则可以申请一个 Gitee 的个人令牌，确保个人令牌**具有 issue 的权限即可**，再将个人令牌填入云端模式设置中的贡献者模式中 ![Pasted image 20250112233208](https://cdn.pkmer.cn/images/202501222228839.png!pkmer)
...
4. 确保无误后点击 `共享译文` 按钮并根据提示确认 ![Pasted image 20250112233215](https://cdn.pkmer.cn/images/202501222228840.png!pkmer)
